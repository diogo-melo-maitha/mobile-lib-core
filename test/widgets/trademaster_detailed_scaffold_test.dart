...
import 'package:tm_lib_core/widgets/design/trademaster_detailed_scaffold.dart';
...
void main() {
  ...
  group('DetailedScaffold tests', () {
    testWidgets('DetailedScaffold is properly created', (tester) async {
      await tester.pumpWidget(TestUtils.buildTestableWidget(const TrademasterDetailedScaffold(
        key: key,
        body: Text(''),
      )));
