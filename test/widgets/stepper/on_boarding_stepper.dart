...
void main() {
  ...
  group('DefaultStepper tests', () {
    testWidgets('DefaultButton is properly created', (tester) async {
      await tester
          .pumpWidget(TmTestUtils.buildTestableWidget(const TmOnBoardingStepper(
        key: key,
        state: 1,
      )));
    ...
    testWidgets('Given backColor is properly used', (tester) async {
      ...
      final backShape =
          tester.widget<Container>(find.byKey(TmOnBoardingStepper.backShapeKey));
    ...
    testWidgets('Given filledColor is properly used', (tester) async {
      ...
      final frontShape =
          tester.widget<Container>(find.byKey(TmOnBoardingStepper.frontShapeKey));
    ...
    testWidgets('Given state 1 is properly applied', (tester) async {
      ...
      expect((secondText.style as TextStyle).color,
          TmColors.disabledText);
      expect(
          (thirdText.style as TextStyle).color, TmColors.disabledText);
    });
